...
* Request the datasets (full, unmodified, using DB access), source code, and supplementary material: [Google Forms](https://forms.gle/BxRuLGxixg2Nq4Q59)
* See presentation: [Google Slides](https://docs.google.com/presentation/d/1a8qcstQHls4HjikPIWICRFCt-XvyRzrlh3PYqxBOCko/)
...
The scraper is based on our earlier publication [Automating Website Registration for Studying GDPR Compliance](https://karelkubicek.github.io/post/reg-www). This reference was accidentally omitted in the camera-ready version, but is now added in the author version here.
