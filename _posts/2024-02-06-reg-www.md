...
* Download author pre-print of the paper: [PDF](https://karelkubicek.github.io/assets/pdf/Automating_Website_Registration_for_Studying_GDPR_Compliance.pdf)
* Presentation: TBA
* See presentation: 3 min advertisement TBA, full conference talk TBA
* Request the [datasets, source code, and supplementary material](https://forms.gle/KzKwqVLy2WUuxed2A)
...
![Crawling intermediary results in a Sankey plot](https://karelkubicek.github.io/assets/images/reg-www/sankey.svg)
*Sankey diagram illustrating the intermediary results of our crawler.*
...
![Table of ML performance](https://karelkubicek.github.io/assets/images/reg-www/sankey.svg)
...
![Decision tree for ePrivacy requirements](https://karelkubicek.github.io/assets/images/reg-www/tree_eprivacy.svg){: style="float: left; width:50%"}![Decision tree for GDPR requirements](https://karelkubicek.github.io/assets/images/reg-www/tree_gdpr.svg){: style="float: left;width:50%;margin-bottom: 100px;margin-top: 100px;"}
...
![Security threats results](https://karelkubicek.github.io/assets/images/reg-www/sec_violations.svg){: style="float: left; width:50%"}![Form violations results](https://karelkubicek.github.io/assets/images/reg-www/form_violations.svg){: style="float: left;width:50%;margin-bottom: 100px;margin-top: 100px;"}
...
![Email opt-in violations](https://karelkubicek.github.io/assets/images/reg-www/first_email_type.svg){: style="float: left; width:50%"}![Email sharing violations](https://karelkubicek.github.io/assets/images/reg-www/mail_sharing_violations.svg){: style="float: left;width:50%;margin-bottom: 100px;margin-top: 100px;"}
