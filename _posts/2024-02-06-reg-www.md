...
![Decision tree for ePrivacy requirements](https://karelkubicek.github.io/assets/images/www/tree_eprivacy.svg){: style="float: left; width:50%"}![Decision tree for GDPR requirements](https://karelkubicek.github.io/assets/images/www/tree_gdpr.svg){: style="float: left;width:50%"}
